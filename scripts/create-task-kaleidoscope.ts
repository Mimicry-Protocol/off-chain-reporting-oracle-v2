...
import { version } from "../web3-functions/kaleidoscope/index";
// import { ethers, w3f } from "hardhat";

task("create-kaleidoscope", "Create w3f task for Mimicry Kaleidoscope")
  ...
  .setAction(async (taskArgs, hre) => {
    ...
    const oracleW3f = w3f.get("kaleidoscope");
